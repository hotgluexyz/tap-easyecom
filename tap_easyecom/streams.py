...
class SellOrdersStream(EasyEcomStream):
    ...
    schema = th.PropertiesList(
        th.Property("suborders", th.ArrayType(th.ObjectType(
            th.Property("suborder_id", th.IntegerType),
            th.Property("suborder_num", th.StringType),
            th.Property("suborder_reference_num", th.StringType),
            ...
            th.Property("suborder_history", th.ObjectType(
                ...
                th.Property("hold_datetime", th.DateTimeType),
                th.Property("unhold_datetime", th.DateTimeType),
                th.Property("inventory_assigned_datetime", th.DateTimeType),
            )),
            th.Property("meta", th.ObjectType()),
            th.Property("selling_price", th.StringType),
            ...
            th.Property("sub_product_count", th.IntegerType),
            ...
            th.Property("tagloop_required", th.BooleanType),
        ))),
        ...
        th.Property("shipping_history", th.CustomType({"type": ["array", "null"]})),
