...
class SellOrdersStream(EasyEcomStream):
    ...
    schema = th.PropertiesList(
        ...
        # TODO: what??
        th.Property("Package Weight", th.CustomType({"type": ["number", "null","string"]})),
        th.Property("Package Height", th.CustomType({"type": ["number", "null","string"]})),
        th.Property("Package Length", th.CustomType({"type": ["number", "null","string"]})),
        th.Property("Package Width", th.CustomType({"type": ["number", "null","string"]})),
